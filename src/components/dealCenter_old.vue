<template>
  <div class="home home-box bg-main main-bg">
    <div class="main flex">
      <div class="main-l fl flex" style="width:80%;">
        <div class="sidebar bg-part part-bg" style="width:24%;margin-right:6px;">
          <market></market>
        </div>
        <div class="chart_wrap flex column bgWhite part-bg" style="width:76%;">
            <!-- <chart></chart> -->
            <div style="min-width:67%" class="bg-part part-bg tv_wrap">
              <!--<kline></kline>-->
              <tv></tv>
            </div>
      ...
      <div class="main-r bgWhite part-bg"  style="width:20%;">
