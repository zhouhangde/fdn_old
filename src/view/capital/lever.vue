    ...
    <div class="lever">
        ...
        <div class="leverbody contentBK ft12">
            ...
            <ul class="titlebox  clearfix">
                <li class="w20" style="text-align:center">杠杆账户</li>
                <li class="w20 tr" style="text-align:center">可用</li>
                <li class="w20 tr" style="text-align:center">冻结</li>
                <li class="w20 tr" style="text-align:center">折合(CNY)</li>
                <li class="w20 tr" style="text-align:center">操作</li>
            ...
            <!-- 合约账户的table内容 -->
            <ul class="contentbox ">
                <li class="clearfix flex" v-for="(item,index) in list" :key="index" @click="go_legalAccount(item.currency_id)">
                    <p class="w20 l40" style="text-align:center">{{item.currency_name}}</p>
                    <p class="w20 tr flex column center" style="text-align:center">
                    ...
                    <p class="w20 tr flex column between" style="cursor:pointer;text-align:center">
                ...
                <div class="dia-content ">
                    ...
                    <div class="div-input mt20">
                        ...
                        <div class="dia-coin flex tc mt10 ft12 ">
                            <p v-for="(item,index) in coins" :class="{select:index==current}" :key="index" @click="chooseCoin(index)">{{item.coin}}<i></i></p>
                        </div>
                    </div>
                    <div class="div-input mt20">
