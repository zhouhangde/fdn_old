      ...
      <div class="flex">
        ...
        <div class="title">
            <div class="tab_title clr-part bold">
                <span v-for="(url,index) in urlList" :class="{'': index == isUrl}" class="cor1" @click="changeType(index,url.url)">{{url.title}}</span>
            </div>
        ...
        <div class="content">
            <ul class="list-title fColor2 ft12 clear bdr-part">
                ...
                <li class="fl w10">已成交</li>
                <li class="fl w10">未成交</li>
        ...
        <!---历史委托--->
        <div>
        <div class="his cor1 bold">历史委托</div>
        <div class="content">
            <ul class="list-title fColor2 ft12 clear bdr-part">
        ...
        <!--币种信息-->
        <div class="right w20 bgWhite ptb20 plr10">
           <p class="cor1 bold ft14">基本信息</p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">币种名称</span><span class="gray_blue bold">{{c_info.zh_name}}</span></p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">发行时间</span><span class="gray_blue bold">{{c_info.publish_time}}</span></p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">发行总量</span><span class="gray_blue bold">{{c_info.publish_total}}</span></p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">流通总量</span><span class="gray_blue bold">{{c_info.online_total}}</span></p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">众筹价格</span><span class="gray_blue bold">{{c_info.cf_price}}</span></p>
           <p class="flex alcenter ptb10 between ft12"><span class="gray_cor">相关链接</span><a :href="c_info.ow_url" target="_blank" class="gray_blue bold">官网</a><a :href="c_info.wp_url" target="_blank" class="gray_blue bold">白皮书</a><a :href="c_info.search_url" target="_blank" class="gray_blue bold">区块查询</a></p>
           <p class="ptb10 gray_cor ft12">简介</p>
...
export default {
  ...
  data() {
    return {
      ...
      wayList: [{ title: this.$t('center.inbuy'), type: "in" }, { title: this.$t('center.outsell'), type: "out" }],
      enList: [],
      enList01: [],
      enList02: [],
      hisList: [],
