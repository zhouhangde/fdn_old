...
<div id="bind-email" class="bg-main clr-part">
    ...
    <div class="contentBK">
        <div class="content-wrap">
            <div class="account">
               <p class="main_title ml30">{{$t('transfer.changePhone')}}</p>
                ...
                <div class="main" v-if="!isshow">
                    <div class="register-input">
                        ...
                        <input type="text" class="input-main input-content"  v-model="account_number01" id="account01" :placeholder="$t('transfer.newPhone')">
                    </div>
                     <div class="register-input code-input" >
                        <span class="register-item">{{$t('code')}}</span>
                        <div class="code-box flex">
...
export default {
  ...
  methods: {
    ...
    bind(){
      if(this.phoneCode01 == ''){
        layer.msg(this.$t('transfer.phoneCode'))
      }
      this.$http({
        url:'api/user/amend_phone',
        method:'post',
        data:{
          // email_code:this.phoneCode,
          new_phone:this.account_number01,
          phone_code:this.phoneCode01
        }
      }).then(res=>{
          layer.msg(res.data.message);
          if(res.data.type == 'ok'){
